...
const Uint8 DEFAULT_DISPLAY_PRECISION = 2;
...
public:
	...
	/* RVALUE: false -> length and/or height Out Of Range of Matrice					   */
	/* RVALUE: true -> length and height In Range of Matrice							   */
	/* ------------------------------------------------------------------------------------*/
	bool assertIndex
	(
		/* IN */
...
public:
	...
	void SETprecision(Uint8 precision);
